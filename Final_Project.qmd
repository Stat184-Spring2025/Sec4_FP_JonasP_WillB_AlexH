...
Our second and supplementary data set also originates from Kaggle. The author of this data set is MD. Shariful Islam and he describes the data set as “a statistical research on the effects of mental health.” The data for this set was collected via a Google form survey from students studying at the International Islamic University of Malaysia. The data set includes the attributes of a Timestamp/date the survey was filled, Student gender, age, major/course, current year, Marital status, depression status, anxiety status, and whether or not the student has panic attacks. For this data set we are primarily interested in the students major and mental health (depression and anxiety status).
